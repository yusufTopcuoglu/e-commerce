package com.dolap.product.strings;

public class ValidationMessages {
	public static final String NULL_PRODUCT_ATTRIBUTE_EXCEPTION = "Product attributes can not be null";

	public static final String NULL_PRODUCT_REQUEST_ATTRIBUTE_EXCEPTION = "Product request attributes can not be null";
	...
	public static final String INVALID_PRODUCT_COUNT_EXCEPTION = "Product count must not be less than one!";
}
